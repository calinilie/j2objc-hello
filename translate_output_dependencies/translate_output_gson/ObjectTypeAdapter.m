...
- (id)readWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)inArg {
  ComGoogleGsonStreamJsonTokenEnum *token = [((ComGoogleGsonStreamJsonReader *) nil_chk(inArg)) peek];
  {
    ...
    switch ([token ordinal]) {
      ...
      map = [new_ComGoogleGsonInternalLinkedTreeMap_init() autorelease];
      [inArg beginObject];
      while ([inArg hasNext]) {
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindObjectTypeAdapter class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonInternalBindObjectTypeAdapter_FACTORY_, new_ComGoogleGsonInternalBindObjectTypeAdapter_$1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "FACTORY_", NULL, 0x19, "Lcom.google.gson.TypeAdapterFactory;", &ComGoogleGsonInternalBindObjectTypeAdapter_FACTORY_, NULL, .constantValue.asLong = 0 },
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
  ...
  if ([((ComGoogleGsonReflectTypeToken *) nil_chk(type)) getRawType] == NSObject_class_()) {
    return (ComGoogleGsonTypeAdapter *) check_class_cast([new_ComGoogleGsonInternalBindObjectTypeAdapter_initWithComGoogleGsonGson_(gson) autorelease], [ComGoogleGsonTypeAdapter class]);
  }
  return nil;
}
