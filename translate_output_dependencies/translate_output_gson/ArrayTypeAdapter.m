...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindArrayTypeAdapter class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonInternalBindArrayTypeAdapter_FACTORY_, new_ComGoogleGsonInternalBindArrayTypeAdapter_$1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "FACTORY_", NULL, 0x19, "Lcom.google.gson.TypeAdapterFactory;", &ComGoogleGsonInternalBindArrayTypeAdapter_FACTORY_, NULL, .constantValue.asLong = 0 },
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
  ...
  return [new_ComGoogleGsonInternalBindArrayTypeAdapter_initWithComGoogleGsonGson_withComGoogleGsonTypeAdapter_withIOSClass_(gson, componentTypeAdapter, ComGoogleGsonInternal$Gson$Types_getRawTypeWithJavaLangReflectType_(componentType)) autorelease];
}
