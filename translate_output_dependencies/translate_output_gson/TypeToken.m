...
void ComGoogleGsonReflectTypeToken_init(ComGoogleGsonReflectTypeToken *self) {
  NSObject_init(self);
  JreStrongAssign(&self->type_, ComGoogleGsonReflectTypeToken_getSuperclassTypeParameterWithIOSClass_([self getClass]));
  JreStrongAssign(&self->rawType_, (IOSClass *) check_class_cast(ComGoogleGsonInternal$Gson$Types_getRawTypeWithJavaLangReflectType_(self->type_), [IOSClass class]));
...
void ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(ComGoogleGsonReflectTypeToken *self, id<JavaLangReflectType> type) {
  NSObject_init(self);
  JreStrongAssign(&self->type_, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(type)));
  JreStrongAssign(&self->rawType_, (IOSClass *) check_class_cast(ComGoogleGsonInternal$Gson$Types_getRawTypeWithJavaLangReflectType_(self->type_), [IOSClass class]));
  self->hashCode_ = ((jint) [((id<JavaLangReflectType>) nil_chk(self->type_)) hash]);
}
...
id<JavaLangReflectType> ComGoogleGsonReflectTypeToken_getSuperclassTypeParameterWithIOSClass_(IOSClass *subclass) {
  ...
  if ([superclass_ isKindOfClass:[IOSClass class]]) {
    @throw [new_JavaLangRuntimeException_initWithNSString_(@"Missing type parameter.") autorelease];
  }
  id<JavaLangReflectParameterizedType> parameterized = (id<JavaLangReflectParameterizedType>) check_protocol_cast(superclass_, JavaLangReflectParameterizedType_class_());
...
jboolean ComGoogleGsonReflectTypeToken_isAssignableFromWithJavaLangReflectType_withJavaLangReflectGenericArrayType_(id<JavaLangReflectType> from, id<JavaLangReflectGenericArrayType> to) {
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:toGenericComponentType]) {
    ...
    if ([JavaLangReflectGenericArrayType_class_() isInstance:from]) {
      t = [((id<JavaLangReflectGenericArrayType>) nil_chk(((id<JavaLangReflectGenericArrayType>) check_protocol_cast(from, JavaLangReflectGenericArrayType_class_())))) getGenericComponentType];
    }
    ...
    return ComGoogleGsonReflectTypeToken_isAssignableFromWithJavaLangReflectType_withJavaLangReflectParameterizedType_withJavaUtilMap_(t, (id<JavaLangReflectParameterizedType>) check_protocol_cast(toGenericComponentType, JavaLangReflectParameterizedType_class_()), [new_JavaUtilHashMap_init() autorelease]);
  }
  return true;
}
...
jboolean ComGoogleGsonReflectTypeToken_isAssignableFromWithJavaLangReflectType_withJavaLangReflectParameterizedType_withJavaUtilMap_(id<JavaLangReflectType> from, id<JavaLangReflectParameterizedType> to, id<JavaUtilMap> typeVarMap) {
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:from]) {
    ptype = (id<JavaLangReflectParameterizedType>) check_protocol_cast(from, JavaLangReflectParameterizedType_class_());
  }
  if (ptype != nil) {
    ...
    for (jint i = 0; i < ((IOSObjectArray *) nil_chk(tArgs))->size_; i++) {
      ...
      while ([JavaLangReflectTypeVariable_class_() isInstance:arg]) {
        id<JavaLangReflectTypeVariable> v = (id<JavaLangReflectTypeVariable>) check_protocol_cast(arg, JavaLangReflectTypeVariable_class_());
  ...
  }
  {
    ...
    while (b__ < e__) {
      ...
      if (ComGoogleGsonReflectTypeToken_isAssignableFromWithJavaLangReflectType_withJavaLangReflectParameterizedType_withJavaUtilMap_(itype, to, [new_JavaUtilHashMap_initWithJavaUtilMap_(typeVarMap) autorelease])) {
        return true;
      }
    }
  }
  id<JavaLangReflectType> sType = [clazz getGenericSuperclass];
  return ComGoogleGsonReflectTypeToken_isAssignableFromWithJavaLangReflectType_withJavaLangReflectParameterizedType_withJavaUtilMap_(sType, to, [new_JavaUtilHashMap_initWithJavaUtilMap_(typeVarMap) autorelease]);
}
...
JavaLangAssertionError *ComGoogleGsonReflectTypeToken_buildUnexpectedTypeErrorWithJavaLangReflectType_withIOSClassArray_(id<JavaLangReflectType> token, IOSObjectArray *expected) {
  ComGoogleGsonReflectTypeToken_initialize();
  JavaLangStringBuilder *exceptionMessage = [new_JavaLangStringBuilder_initWithNSString_(@"Unexpected type. Expected one of: ") autorelease];
  {
  ...
  return [new_JavaLangAssertionError_initWithId_([exceptionMessage description]) autorelease];
}
...
jboolean ComGoogleGsonReflectTypeToken_matchesWithJavaLangReflectType_withJavaLangReflectType_withJavaUtilMap_(id<JavaLangReflectType> from, id<JavaLangReflectType> to, id<JavaUtilMap> typeMap) {
  ComGoogleGsonReflectTypeToken_initialize();
  return [((id<JavaLangReflectType>) nil_chk(to)) isEqual:from] || ([JavaLangReflectTypeVariable_class_() isInstance:from] && [to isEqual:[((id<JavaUtilMap>) nil_chk(typeMap)) getWithId:[((id<JavaLangReflectTypeVariable>) nil_chk(((id<JavaLangReflectTypeVariable>) check_protocol_cast(from, JavaLangReflectTypeVariable_class_())))) getName]]]);
}

ComGoogleGsonReflectTypeToken *ComGoogleGsonReflectTypeToken_getWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ComGoogleGsonReflectTypeToken_initialize();
  return [new_ComGoogleGsonReflectTypeToken_initWithJavaLangReflectType_(type) autorelease];
}
