...
- (ComGoogleGsonJsonArray *)deepCopy {
  ComGoogleGsonJsonArray *result = [new_ComGoogleGsonJsonArray_init() autorelease];
...
- (void)addWithJavaLangBoolean:(JavaLangBoolean *)bool_ {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:bool_ == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE_) : [new_ComGoogleGsonJsonPrimitive_initWithJavaLangBoolean_(bool_) autorelease]];
}

- (void)addWithJavaLangCharacter:(JavaLangCharacter *)character {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:character == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE_) : [new_ComGoogleGsonJsonPrimitive_initWithJavaLangCharacter_(character) autorelease]];
}

- (void)addWithNSNumber:(NSNumber *)number {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:number == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE_) : [new_ComGoogleGsonJsonPrimitive_initWithNSNumber_(number) autorelease]];
}

- (void)addWithNSString:(NSString *)string {
  [((id<JavaUtilList>) nil_chk(elements_)) addWithId:string == nil ? JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE_) : [new_ComGoogleGsonJsonPrimitive_initWithNSString_(string) autorelease]];
}

- (void)addWithComGoogleGsonJsonElement:(ComGoogleGsonJsonElement *)element {
  if (element == nil) {
    element = JreLoadStatic(ComGoogleGsonJsonNull, INSTANCE_);
  }
