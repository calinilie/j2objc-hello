...
+ (void)initialize {
  if (self == [ComGoogleGsonJsonNull class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonJsonNull_INSTANCE_, new_ComGoogleGsonJsonNull_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "INSTANCE_", NULL, 0x19, "Lcom.google.gson.JsonNull;", &ComGoogleGsonJsonNull_INSTANCE_, NULL, .constantValue.asLong = 0 },
  };
