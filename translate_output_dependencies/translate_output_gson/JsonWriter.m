...
- (ComGoogleGsonStreamJsonWriter *)nameWithNSString:(NSString *)name {
  if (name == nil) {
    @throw [new_JavaLangNullPointerException_initWithNSString_(@"name == null") autorelease];
  }
  if (deferredName_ != nil) {
    @throw [new_JavaLangIllegalStateException_init() autorelease];
  }
  if (stackSize_ == 0) {
    @throw [new_JavaLangIllegalStateException_initWithNSString_(@"JsonWriter is closed.") autorelease];
  }
...
- (ComGoogleGsonStreamJsonWriter *)valueWithDouble:(jdouble)value {
  if (JavaLangDouble_isNaNWithDouble_(value) || JavaLangDouble_isInfiniteWithDouble_(value)) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$D", @"Numeric values must be finite, but was ", value)) autorelease];
  }
  ComGoogleGsonStreamJsonWriter_writeDeferredName(self);
  ComGoogleGsonStreamJsonWriter_beforeValueWithBoolean_(self, false);
...
- (ComGoogleGsonStreamJsonWriter *)valueWithNSNumber:(NSNumber *)value {
  ...
  if (!lenient_ && ([((NSString *) nil_chk(string)) isEqual:@"-Infinity"] || [string isEqual:@"Infinity"] || [string isEqual:@"NaN"])) {
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@", @"Numeric values must be finite, but was ", value)) autorelease];
  }
  ComGoogleGsonStreamJsonWriter_beforeValueWithBoolean_(self, false);
...
+ (void)initialize {
  if (self == [ComGoogleGsonStreamJsonWriter class]) {
    {
      JreStrongAssignAndConsume(&ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, [IOSObjectArray newArrayWithLength:128 type:NSString_class_()]);
      for (jint i = 0; i <= (jint) 0x1f; i++) {
        IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, i, NSString_formatWithNSString_withNSObjectArray_(@"\\u%04x", [IOSObjectArray arrayWithObjects:(id[]){ JavaLangInteger_valueOfWithInt_((jint) i) } count:1 type:NSObject_class_()]));
      }
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, '"', @"\\\"");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, '\\', @"\\\\");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, 0x0009, @"\\t");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, 0x0008, @"\\b");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, 0x000a, @"\\n");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, 0x000d, @"\\r");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, 0x000c, @"\\f");
      JreStrongAssign(&ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, [ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_ clone]);
      IOSObjectArray_Set(nil_chk(ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_), '<', @"\\u003c");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, '>', @"\\u003e");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, '&', @"\\u0026");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, '=', @"\\u003d");
      IOSObjectArray_Set(ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, '\'', @"\\u0027");
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "REPLACEMENT_CHARS_", NULL, 0x1a, "[Ljava.lang.String;", &ComGoogleGsonStreamJsonWriter_REPLACEMENT_CHARS_, NULL, .constantValue.asLong = 0 },
    { "HTML_SAFE_REPLACEMENT_CHARS_", NULL, 0x1a, "[Ljava.lang.String;", &ComGoogleGsonStreamJsonWriter_HTML_SAFE_REPLACEMENT_CHARS_, NULL, .constantValue.asLong = 0 },
...
void ComGoogleGsonStreamJsonWriter_initWithJavaIoWriter_(ComGoogleGsonStreamJsonWriter *self, JavaIoWriter *outArg) {
  ...
  if (outArg == nil) {
    @throw [new_JavaLangNullPointerException_initWithNSString_(@"out == null") autorelease];
  }
...
ComGoogleGsonStreamJsonWriter *ComGoogleGsonStreamJsonWriter_closeWithInt_withInt_withNSString_(ComGoogleGsonStreamJsonWriter *self, jint empty, jint nonempty, NSString *closeBracket) {
  ...
  if (context != nonempty && context != empty) {
    @throw [new_JavaLangIllegalStateException_initWithNSString_(@"Nesting problem.") autorelease];
  }
  if (self->deferredName_ != nil) {
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$$", @"Dangling name: ", self->deferredName_)) autorelease];
  }
  self->stackSize_--;
  if (context == nonempty) {
    ComGoogleGsonStreamJsonWriter_newline(self);
...
void ComGoogleGsonStreamJsonWriter_beforeValueWithBoolean_(ComGoogleGsonStreamJsonWriter *self, jboolean root) {
  switch (ComGoogleGsonStreamJsonWriter_peek(self)) {
    ...
    if (!self->lenient_) {
      @throw [new_JavaLangIllegalStateException_initWithNSString_(@"JSON must have only one top-level value.") autorelease];
    }
    case ComGoogleGsonStreamJsonScope_EMPTY_DOCUMENT:
    if (!self->lenient_ && !root) {
      @throw [new_JavaLangIllegalStateException_initWithNSString_(@"JSON must start with an array or an object.") autorelease];
    }
