...
- (JavaSqlTime *)readWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)inArg {
  @synchronized(self) {
    ...
    @try {
      ...
      return [new_JavaSqlTime_initWithLong_([((JavaUtilDate *) nil_chk(date)) getTime]) autorelease];
    }
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindTimeTypeAdapter class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonInternalBindTimeTypeAdapter_FACTORY_, new_ComGoogleGsonInternalBindTimeTypeAdapter_$1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "FACTORY_", NULL, 0x19, "Lcom.google.gson.TypeAdapterFactory;", &ComGoogleGsonInternalBindTimeTypeAdapter_FACTORY_, NULL, .constantValue.asLong = 0 },
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaSqlTime_class_() ? (ComGoogleGsonTypeAdapter *) check_class_cast([new_ComGoogleGsonInternalBindTimeTypeAdapter_init() autorelease], [ComGoogleGsonTypeAdapter class]) : nil;
}
