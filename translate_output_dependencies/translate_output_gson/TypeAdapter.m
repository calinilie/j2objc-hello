...
//  source: src/main/java//com/google/gson/TypeAdapter.java
//
...
- (ComGoogleGsonTypeAdapter *)nullSafe {
  return [new_ComGoogleGsonTypeAdapter_$1_initWithComGoogleGsonTypeAdapter_(self) autorelease];
}
...
- (ComGoogleGsonJsonElement *)toJsonTreeWithId:(id)value {
  @try {
    ComGoogleGsonInternalBindJsonTreeWriter *jsonWriter = [new_ComGoogleGsonInternalBindJsonTreeWriter_init() autorelease];
...
- (id)fromJsonWithNSString:(NSString *)json {
  return ComGoogleGsonTypeAdapter_fromJsonWithJavaIoReader_(self, [new_JavaIoStringReader_initWithNSString_(json) autorelease]);
}

- (id)fromJsonTreeWithComGoogleGsonJsonElement:(ComGoogleGsonJsonElement *)jsonTree {
  @try {
    ComGoogleGsonStreamJsonReader *jsonReader = [new_ComGoogleGsonInternalBindJsonTreeReader_initWithComGoogleGsonJsonElement_(jsonTree) autorelease];
...
void ComGoogleGsonTypeAdapter_toJsonWithJavaIoWriter_withId_(ComGoogleGsonTypeAdapter *self, JavaIoWriter *outArg, id value) {
  ComGoogleGsonStreamJsonWriter *writer = [new_ComGoogleGsonStreamJsonWriter_initWithJavaIoWriter_(outArg) autorelease];
...
id ComGoogleGsonTypeAdapter_fromJsonWithJavaIoReader_(ComGoogleGsonTypeAdapter *self, JavaIoReader *inArg) {
  ComGoogleGsonStreamJsonReader *reader = [new_ComGoogleGsonStreamJsonReader_initWithJavaIoReader_(inArg) autorelease];
...
- (id)readWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)reader {
  if ([((ComGoogleGsonStreamJsonReader *) nil_chk(reader)) peek] == JreLoadStatic(ComGoogleGsonStreamJsonTokenEnum, NULL)) {
    [reader nextNull];
    return nil;
  }
