...
- (JavaSqlDate *)readWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)inArg {
  @synchronized(self) {
    ...
    @try {
      ...
      return [new_JavaSqlDate_initWithLong_(utilDate) autorelease];
    }
...
+ (void)initialize {
  if (self == [ComGoogleGsonInternalBindSqlDateTypeAdapter class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonInternalBindSqlDateTypeAdapter_FACTORY_, new_ComGoogleGsonInternalBindSqlDateTypeAdapter_$1_init());
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "FACTORY_", NULL, 0x19, "Lcom.google.gson.TypeAdapterFactory;", &ComGoogleGsonInternalBindSqlDateTypeAdapter_FACTORY_, NULL, .constantValue.asLong = 0 },
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
                        withComGoogleGsonReflectTypeToken:(ComGoogleGsonReflectTypeToken *)typeToken {
  return [((ComGoogleGsonReflectTypeToken *) nil_chk(typeToken)) getRawType] == JavaSqlDate_class_() ? (ComGoogleGsonTypeAdapter *) check_class_cast([new_ComGoogleGsonInternalBindSqlDateTypeAdapter_init() autorelease], [ComGoogleGsonTypeAdapter class]) : nil;
}
