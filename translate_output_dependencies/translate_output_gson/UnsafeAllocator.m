...
ComGoogleGsonInternalUnsafeAllocator *ComGoogleGsonInternalUnsafeAllocator_create() {
  ...
  @try {
    ...
    return [new_ComGoogleGsonInternalUnsafeAllocator_$1_initWithJavaLangReflectMethod_withId_(allocateInstance, unsafe) autorelease];
  }
  ...
  @try {
    ...
    jint constructorId = [((JavaLangInteger *) nil_chk((JavaLangInteger *) check_class_cast([getConstructorId invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ NSObject_class_() } count:1 type:NSObject_class_()]], [JavaLangInteger class]))) intValue];
    ...
    return [new_ComGoogleGsonInternalUnsafeAllocator_$2_initWithJavaLangReflectMethod_withInt_(newInstance, constructorId) autorelease];
  }
  @catch (JavaLangException *ignored) {
  }
  @try {
    ...
    [((JavaLangReflectMethod *) nil_chk(newInstance)) setAccessibleWithBoolean:true];
    return [new_ComGoogleGsonInternalUnsafeAllocator_$3_initWithJavaLangReflectMethod_(newInstance) autorelease];
  }
  @catch (JavaLangException *ignored) {
  }
  return [new_ComGoogleGsonInternalUnsafeAllocator_$4_init() autorelease];
}
...
- (id)newInstanceWithIOSClass:(IOSClass *)c {
  return (id) [((JavaLangReflectMethod *) nil_chk(val$allocateInstance_)) invokeWithId:val$unsafe_ withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ c } count:1 type:NSObject_class_()]];
}
...
- (id)newInstanceWithIOSClass:(IOSClass *)c {
  return (id) [((JavaLangReflectMethod *) nil_chk(val$newInstance_)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ c, JavaLangInteger_valueOfWithInt_(val$constructorId_) } count:2 type:NSObject_class_()]];
}
...
- (id)newInstanceWithIOSClass:(IOSClass *)c {
  return (id) [((JavaLangReflectMethod *) nil_chk(val$newInstance_)) invokeWithId:nil withNSObjectArray:[IOSObjectArray arrayWithObjects:(id[]){ c, NSObject_class_() } count:2 type:NSObject_class_()]];
}
...
- (id)newInstanceWithIOSClass:(IOSClass *)c {
  @throw [new_JavaLangUnsupportedOperationException_initWithNSString_(JreStrcat("$@", @"Cannot allocate ", c)) autorelease];
}
