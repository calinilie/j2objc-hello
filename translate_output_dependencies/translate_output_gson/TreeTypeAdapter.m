...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithComGoogleGsonJsonSerializer:withComGoogleGsonJsonDeserializer:withComGoogleGsonGson:withComGoogleGsonReflectTypeToken:withComGoogleGsonTypeAdapterFactory:", "TreeTypeAdapter", NULL, 0x2, NULL, NULL },
    ...
    { "newFactoryWithComGoogleGsonReflectTypeToken:withId:", "newFactory", "Lcom.google.gson.TypeAdapterFactory;", 0x9, NULL, NULL },
    { "newFactoryWithMatchRawTypeWithComGoogleGsonReflectTypeToken:withId:", "newFactoryWithMatchRawType", "Lcom.google.gson.TypeAdapterFactory;", 0x9, NULL, NULL },
    { "newTypeHierarchyFactoryWithIOSClass:withId:", "newTypeHierarchyFactory", "Lcom.google.gson.TypeAdapterFactory;", 0x9, NULL, NULL },
  };
...
id<ComGoogleGsonTypeAdapterFactory> ComGoogleGsonTreeTypeAdapter_newFactoryWithComGoogleGsonReflectTypeToken_withId_(ComGoogleGsonReflectTypeToken *exactType, id typeAdapter) {
  ...
  return [new_ComGoogleGsonTreeTypeAdapter_SingleTypeFactory_initWithId_withComGoogleGsonReflectTypeToken_withBoolean_withIOSClass_(typeAdapter, exactType, false, nil) autorelease];
}
...
id<ComGoogleGsonTypeAdapterFactory> ComGoogleGsonTreeTypeAdapter_newFactoryWithMatchRawTypeWithComGoogleGsonReflectTypeToken_withId_(ComGoogleGsonReflectTypeToken *exactType, id typeAdapter) {
  ...
  return [new_ComGoogleGsonTreeTypeAdapter_SingleTypeFactory_initWithId_withComGoogleGsonReflectTypeToken_withBoolean_withIOSClass_(typeAdapter, exactType, matchRawType, nil) autorelease];
}
...
id<ComGoogleGsonTypeAdapterFactory> ComGoogleGsonTreeTypeAdapter_newTypeHierarchyFactoryWithIOSClass_withId_(IOSClass *hierarchyType, id typeAdapter) {
  ComGoogleGsonTreeTypeAdapter_initialize();
  return [new_ComGoogleGsonTreeTypeAdapter_SingleTypeFactory_initWithId_withComGoogleGsonReflectTypeToken_withBoolean_withIOSClass_(typeAdapter, nil, false, hierarchyType) autorelease];
}
...
- (ComGoogleGsonTypeAdapter *)createWithComGoogleGsonGson:(ComGoogleGsonGson *)gson
  ...
  return matches ? [new_ComGoogleGsonTreeTypeAdapter_initWithComGoogleGsonJsonSerializer_withComGoogleGsonJsonDeserializer_withComGoogleGsonGson_withComGoogleGsonReflectTypeToken_withComGoogleGsonTypeAdapterFactory_((id<ComGoogleGsonJsonSerializer>) check_protocol_cast(serializer_, ComGoogleGsonJsonSerializer_class_()), (id<ComGoogleGsonJsonDeserializer>) check_protocol_cast(deserializer_, ComGoogleGsonJsonDeserializer_class_()), gson, type, self) autorelease] : nil;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    { "initWithId:withComGoogleGsonReflectTypeToken:withBoolean:withIOSClass:", "SingleTypeFactory", NULL, 0x2, NULL, NULL },
...
void ComGoogleGsonTreeTypeAdapter_SingleTypeFactory_initWithId_withComGoogleGsonReflectTypeToken_withBoolean_withIOSClass_(ComGoogleGsonTreeTypeAdapter_SingleTypeFactory *self, id typeAdapter, ComGoogleGsonReflectTypeToken *exactType, jboolean matchRawType, IOSClass *hierarchyType) {
  NSObject_init(self);
  JreStrongAssign(&self->serializer_, [ComGoogleGsonJsonSerializer_class_() isInstance:typeAdapter] ? (id<ComGoogleGsonJsonSerializer>) check_protocol_cast(typeAdapter, ComGoogleGsonJsonSerializer_class_()) : nil);
  JreStrongAssign(&self->deserializer_, [ComGoogleGsonJsonDeserializer_class_() isInstance:typeAdapter] ? (id<ComGoogleGsonJsonDeserializer>) check_protocol_cast(typeAdapter, ComGoogleGsonJsonDeserializer_class_()) : nil);
