...
+ (void)initialize {
  if (self == [ComGoogleGsonInternal$Gson$Types class]) {
    JreStrongAssignAndConsume(&ComGoogleGsonInternal$Gson$Types_EMPTY_TYPE_ARRAY_, [IOSObjectArray newArrayWithObjects:(id[]){  } count:0 type:JavaLangReflectType_class_()]);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "EMPTY_TYPE_ARRAY_", NULL, 0x18, "[Ljava.lang.reflect.Type;", &ComGoogleGsonInternal$Gson$Types_EMPTY_TYPE_ARRAY_, NULL, .constantValue.asLong = 0 },
  };
...
id<JavaLangReflectParameterizedType> ComGoogleGsonInternal$Gson$Types_newParameterizedTypeWithOwnerWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_(id<JavaLangReflectType> ownerType, id<JavaLangReflectType> rawType, IOSObjectArray *typeArguments) {
  ...
  return [new_ComGoogleGsonInternal$Gson$Types_ParameterizedTypeImpl_initWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_(ownerType, rawType, typeArguments) autorelease];
}
...
id<JavaLangReflectGenericArrayType> ComGoogleGsonInternal$Gson$Types_arrayOfWithJavaLangReflectType_(id<JavaLangReflectType> componentType) {
  ComGoogleGsonInternal$Gson$Types_initialize();
  return [new_ComGoogleGsonInternal$Gson$Types_GenericArrayTypeImpl_initWithJavaLangReflectType_(componentType) autorelease];
}
...
id<JavaLangReflectWildcardType> ComGoogleGsonInternal$Gson$Types_subtypeOfWithJavaLangReflectType_(id<JavaLangReflectType> bound) {
  ComGoogleGsonInternal$Gson$Types_initialize();
  return [new_ComGoogleGsonInternal$Gson$Types_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_([IOSObjectArray arrayWithObjects:(id[]){ bound } count:1 type:JavaLangReflectType_class_()], ComGoogleGsonInternal$Gson$Types_EMPTY_TYPE_ARRAY_) autorelease];
}
...
id<JavaLangReflectType> ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ...
  if ([type isKindOfClass:[IOSClass class]]) {
    ...
    return [((IOSClass *) nil_chk(c)) isArray] ? [new_ComGoogleGsonInternal$Gson$Types_GenericArrayTypeImpl_initWithJavaLangReflectType_(ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_([c getComponentType])) autorelease] : c;
  }
  else if ([JavaLangReflectParameterizedType_class_() isInstance:type]) {
    id<JavaLangReflectParameterizedType> p = (id<JavaLangReflectParameterizedType>) check_protocol_cast(type, JavaLangReflectParameterizedType_class_());
    return [new_ComGoogleGsonInternal$Gson$Types_ParameterizedTypeImpl_initWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_([((id<JavaLangReflectParameterizedType>) nil_chk(p)) getOwnerType], [p getRawType], [p getActualTypeArguments]) autorelease];
  }
  else if ([JavaLangReflectGenericArrayType_class_() isInstance:type]) {
    id<JavaLangReflectGenericArrayType> g = (id<JavaLangReflectGenericArrayType>) check_protocol_cast(type, JavaLangReflectGenericArrayType_class_());
    return [new_ComGoogleGsonInternal$Gson$Types_GenericArrayTypeImpl_initWithJavaLangReflectType_([((id<JavaLangReflectGenericArrayType>) nil_chk(g)) getGenericComponentType]) autorelease];
  }
  else if ([JavaLangReflectWildcardType_class_() isInstance:type]) {
    id<JavaLangReflectWildcardType> w = (id<JavaLangReflectWildcardType>) check_protocol_cast(type, JavaLangReflectWildcardType_class_());
    return [new_ComGoogleGsonInternal$Gson$Types_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_([((id<JavaLangReflectWildcardType>) nil_chk(w)) getUpperBounds], [w getLowerBounds]) autorelease];
  }
  else {
    return type;
  }
...
IOSClass *ComGoogleGsonInternal$Gson$Types_getRawTypeWithJavaLangReflectType_(id<JavaLangReflectType> type) {
  ...
  if ([type isKindOfClass:[IOSClass class]]) {
    ...
    id<JavaLangReflectParameterizedType> parameterizedType = (id<JavaLangReflectParameterizedType>) check_protocol_cast(type, JavaLangReflectParameterizedType_class_());
    ...
    id<JavaLangReflectType> componentType = [((id<JavaLangReflectGenericArrayType>) nil_chk(((id<JavaLangReflectGenericArrayType>) check_protocol_cast(type, JavaLangReflectGenericArrayType_class_())))) getGenericComponentType];
    ...
    return ComGoogleGsonInternal$Gson$Types_getRawTypeWithJavaLangReflectType_(IOSObjectArray_Get(nil_chk([((id<JavaLangReflectWildcardType>) nil_chk(((id<JavaLangReflectWildcardType>) check_protocol_cast(type, JavaLangReflectWildcardType_class_())))) getUpperBounds]), 0));
  }
  else {
    NSString *className_ = type == nil ? @"null" : [[type getClass] getName];
    @throw [new_JavaLangIllegalArgumentException_initWithNSString_(JreStrcat("$@$$", @"Expected a Class, ParameterizedType, or GenericArrayType, but <", type, @"> is of type ", className_)) autorelease];
  }
}
...
jboolean ComGoogleGsonInternal$Gson$Types_equalsWithJavaLangReflectType_withJavaLangReflectType_(id<JavaLangReflectType> a, id<JavaLangReflectType> b) {
  ...
  if (a == b) {
    ...
    id<JavaLangReflectParameterizedType> pa = (id<JavaLangReflectParameterizedType>) check_protocol_cast(a, JavaLangReflectParameterizedType_class_());
    id<JavaLangReflectParameterizedType> pb = (id<JavaLangReflectParameterizedType>) check_protocol_cast(b, JavaLangReflectParameterizedType_class_());
    ...
    id<JavaLangReflectGenericArrayType> ga = (id<JavaLangReflectGenericArrayType>) check_protocol_cast(a, JavaLangReflectGenericArrayType_class_());
    id<JavaLangReflectGenericArrayType> gb = (id<JavaLangReflectGenericArrayType>) check_protocol_cast(b, JavaLangReflectGenericArrayType_class_());
    ...
    id<JavaLangReflectWildcardType> wa = (id<JavaLangReflectWildcardType>) check_protocol_cast(a, JavaLangReflectWildcardType_class_());
    id<JavaLangReflectWildcardType> wb = (id<JavaLangReflectWildcardType>) check_protocol_cast(b, JavaLangReflectWildcardType_class_());
    ...
    id<JavaLangReflectTypeVariable> va = (id<JavaLangReflectTypeVariable>) check_protocol_cast(a, JavaLangReflectTypeVariable_class_());
    id<JavaLangReflectTypeVariable> vb = (id<JavaLangReflectTypeVariable>) check_protocol_cast(b, JavaLangReflectTypeVariable_class_());
...
id<JavaLangReflectType> ComGoogleGsonInternal$Gson$Types_getCollectionElementTypeWithJavaLangReflectType_withIOSClass_(id<JavaLangReflectType> context, IOSClass *contextRawType) {
  ...
  if ([JavaLangReflectWildcardType_class_() isInstance:collectionType]) {
    collectionType = IOSObjectArray_Get(nil_chk([((id<JavaLangReflectWildcardType>) nil_chk(((id<JavaLangReflectWildcardType>) check_protocol_cast(collectionType, JavaLangReflectWildcardType_class_())))) getUpperBounds]), 0);
  }
  if ([JavaLangReflectParameterizedType_class_() isInstance:collectionType]) {
    return IOSObjectArray_Get(nil_chk([((id<JavaLangReflectParameterizedType>) nil_chk(((id<JavaLangReflectParameterizedType>) check_protocol_cast(collectionType, JavaLangReflectParameterizedType_class_())))) getActualTypeArguments]), 0);
  }
  return NSObject_class_();
}
...
IOSObjectArray *ComGoogleGsonInternal$Gson$Types_getMapKeyAndValueTypesWithJavaLangReflectType_withIOSClass_(id<JavaLangReflectType> context, IOSClass *contextRawType) {
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:mapType]) {
    id<JavaLangReflectParameterizedType> mapParameterizedType = (id<JavaLangReflectParameterizedType>) check_protocol_cast(mapType, JavaLangReflectParameterizedType_class_());
...
id<JavaLangReflectType> ComGoogleGsonInternal$Gson$Types_resolveWithJavaLangReflectType_withIOSClass_withJavaLangReflectType_(id<JavaLangReflectType> context, IOSClass *contextRawType, id<JavaLangReflectType> toResolve) {
  ...
  while (true) {
    if ([JavaLangReflectTypeVariable_class_() isInstance:toResolve]) {
      id<JavaLangReflectTypeVariable> typeVariable = (id<JavaLangReflectTypeVariable>) check_protocol_cast(toResolve, JavaLangReflectTypeVariable_class_());
      ...
      id<JavaLangReflectGenericArrayType> original = (id<JavaLangReflectGenericArrayType>) check_protocol_cast(toResolve, JavaLangReflectGenericArrayType_class_());
      ...
      id<JavaLangReflectParameterizedType> original = (id<JavaLangReflectParameterizedType>) check_protocol_cast(toResolve, JavaLangReflectParameterizedType_class_());
      ...
      id<JavaLangReflectWildcardType> original = (id<JavaLangReflectWildcardType>) check_protocol_cast(toResolve, JavaLangReflectWildcardType_class_());
...
id<JavaLangReflectType> ComGoogleGsonInternal$Gson$Types_resolveTypeVariableWithJavaLangReflectType_withIOSClass_withJavaLangReflectTypeVariable_(id<JavaLangReflectType> context, IOSClass *contextRawType, id<JavaLangReflectTypeVariable> unknown) {
  ...
  if ([JavaLangReflectParameterizedType_class_() isInstance:declaredBy]) {
    ...
    return IOSObjectArray_Get(nil_chk([((id<JavaLangReflectParameterizedType>) nil_chk(((id<JavaLangReflectParameterizedType>) check_protocol_cast(declaredBy, JavaLangReflectParameterizedType_class_())))) getActualTypeArguments]), index);
  }
  return unknown;
}
...
- (jboolean)isEqual:(id)other {
  return [JavaLangReflectParameterizedType_class_() isInstance:other] && ComGoogleGsonInternal$Gson$Types_equalsWithJavaLangReflectType_withJavaLangReflectType_(self, (id<JavaLangReflectParameterizedType>) check_protocol_cast(other, JavaLangReflectParameterizedType_class_()));
}
...
- (NSString *)description {
  JavaLangStringBuilder *stringBuilder = [new_JavaLangStringBuilder_initWithInt_(30 * (((IOSObjectArray *) nil_chk(typeArguments_))->size_ + 1)) autorelease];
  [stringBuilder appendWithNSString:ComGoogleGsonInternal$Gson$Types_typeToStringWithJavaLangReflectType_(rawType_)];
  if (typeArguments_->size_ == 0) {
    return [stringBuilder description];
  }
  [((JavaLangStringBuilder *) nil_chk([stringBuilder appendWithNSString:@"<"])) appendWithNSString:ComGoogleGsonInternal$Gson$Types_typeToStringWithJavaLangReflectType_(IOSObjectArray_Get(typeArguments_, 0))];
  for (jint i = 1; i < typeArguments_->size_; i++) {
    [((JavaLangStringBuilder *) nil_chk([stringBuilder appendWithNSString:@", "])) appendWithNSString:ComGoogleGsonInternal$Gson$Types_typeToStringWithJavaLangReflectType_(IOSObjectArray_Get(typeArguments_, i))];
  }
...
void ComGoogleGsonInternal$Gson$Types_ParameterizedTypeImpl_initWithJavaLangReflectType_withJavaLangReflectType_withJavaLangReflectTypeArray_(ComGoogleGsonInternal$Gson$Types_ParameterizedTypeImpl *self, id<JavaLangReflectType> ownerType, id<JavaLangReflectType> rawType, IOSObjectArray *typeArguments) {
  ...
  JreStrongAssign(&self->ownerType_, ownerType == nil ? nil : ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(ownerType));
  JreStrongAssign(&self->rawType_, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(rawType));
  ...
  for (jint t = 0; t < ((IOSObjectArray *) nil_chk(self->typeArguments_))->size_; t++) {
    ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(IOSObjectArray_Get(self->typeArguments_, t));
    ComGoogleGsonInternal$Gson$Types_checkNotPrimitiveWithJavaLangReflectType_(IOSObjectArray_Get(self->typeArguments_, t));
    IOSObjectArray_Set(self->typeArguments_, t, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(IOSObjectArray_Get(self->typeArguments_, t)));
  }
}
...
- (jboolean)isEqual:(id)o {
  return [JavaLangReflectGenericArrayType_class_() isInstance:o] && ComGoogleGsonInternal$Gson$Types_equalsWithJavaLangReflectType_withJavaLangReflectType_(self, (id<JavaLangReflectGenericArrayType>) check_protocol_cast(o, JavaLangReflectGenericArrayType_class_()));
}
...
void ComGoogleGsonInternal$Gson$Types_GenericArrayTypeImpl_initWithJavaLangReflectType_(ComGoogleGsonInternal$Gson$Types_GenericArrayTypeImpl *self, id<JavaLangReflectType> componentType) {
  NSObject_init(self);
  JreStrongAssign(&self->componentType_, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(componentType));
}
...
- (IOSObjectArray *)getLowerBounds {
  return lowerBound_ != nil ? [IOSObjectArray arrayWithObjects:(id[]){ lowerBound_ } count:1 type:JavaLangReflectType_class_()] : JreLoadStatic(ComGoogleGsonInternal$Gson$Types, EMPTY_TYPE_ARRAY_);
}

- (jboolean)isEqual:(id)other {
  return [JavaLangReflectWildcardType_class_() isInstance:other] && ComGoogleGsonInternal$Gson$Types_equalsWithJavaLangReflectType_withJavaLangReflectType_(self, (id<JavaLangReflectWildcardType>) check_protocol_cast(other, JavaLangReflectWildcardType_class_()));
}
...
void ComGoogleGsonInternal$Gson$Types_WildcardTypeImpl_initWithJavaLangReflectTypeArray_withJavaLangReflectTypeArray_(ComGoogleGsonInternal$Gson$Types_WildcardTypeImpl *self, IOSObjectArray *upperBounds, IOSObjectArray *lowerBounds) {
  ...
  if (lowerBounds->size_ == 1) {
    ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(IOSObjectArray_Get(lowerBounds, 0));
    ...
    JreStrongAssign(&self->lowerBound_, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(IOSObjectArray_Get(lowerBounds, 0)));
    JreStrongAssign(&self->upperBound_, NSObject_class_());
  }
  else {
    ComGoogleGsonInternal$Gson$Preconditions_checkNotNullWithId_(IOSObjectArray_Get(upperBounds, 0));
    ...
    JreStrongAssign(&self->upperBound_, ComGoogleGsonInternal$Gson$Types_canonicalizeWithJavaLangReflectType_(IOSObjectArray_Get(upperBounds, 0)));
  }
}
