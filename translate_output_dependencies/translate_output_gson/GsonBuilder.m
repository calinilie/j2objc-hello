...
@interface ComGoogleGsonGsonBuilder () {
 @public
  ...
  ComGoogleGsonLongSerializationPolicyEnum *longSerializationPolicy_;
...
J2OBJC_FIELD_SETTER(ComGoogleGsonGsonBuilder, longSerializationPolicy_, ComGoogleGsonLongSerializationPolicyEnum *)
...
- (ComGoogleGsonGsonBuilder *)registerTypeAdapterWithJavaLangReflectType:(id<JavaLangReflectType>)type
  ...
  if ([ComGoogleGsonInstanceCreator_class_() isInstance:typeAdapter]) {
    [((id<JavaUtilMap>) nil_chk(instanceCreators_)) putWithId:type withId:(id<ComGoogleGsonInstanceCreator>) check_protocol_cast(typeAdapter, ComGoogleGsonInstanceCreator_class_())];
  }
  ...
  if ([typeAdapter isKindOfClass:[ComGoogleGsonTypeAdapter class]]) {
    [((id<JavaUtilList>) nil_chk(factories_)) addWithId:ComGoogleGsonInternalBindTypeAdapters_newFactoryWithComGoogleGsonReflectTypeToken_withComGoogleGsonTypeAdapter_(ComGoogleGsonReflectTypeToken_getWithJavaLangReflectType_(type), (ComGoogleGsonTypeAdapter *) check_class_cast(typeAdapter, [ComGoogleGsonTypeAdapter class]))];
  }
  return self;
}
...
- (ComGoogleGsonGsonBuilder *)registerTypeHierarchyAdapterWithIOSClass:(IOSClass *)baseType
  ...
  if ([typeAdapter isKindOfClass:[ComGoogleGsonTypeAdapter class]]) {
    [((id<JavaUtilList>) nil_chk(factories_)) addWithId:ComGoogleGsonInternalBindTypeAdapters_newTypeHierarchyFactoryWithIOSClass_withComGoogleGsonTypeAdapter_(baseType, (ComGoogleGsonTypeAdapter *) check_class_cast(typeAdapter, [ComGoogleGsonTypeAdapter class]))];
  }
  return self;
}
...
- (ComGoogleGsonGson *)create {
  ...
  return [new_ComGoogleGsonGson_initWithComGoogleGsonInternalExcluder_withComGoogleGsonFieldNamingStrategy_withJavaUtilMap_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withBoolean_withComGoogleGsonLongSerializationPolicyEnum_withJavaUtilList_(excluder_, fieldNamingPolicy_, instanceCreators_, serializeNulls_, complexMapKeySerialization_, generateNonExecutableJson_, escapeHtmlChars_, prettyPrinting_, serializeSpecialFloatingPointValues_, longSerializationPolicy_, factories) autorelease];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static const J2ObjcMethodInfo methods[] = {
    ...
    { "setLongSerializationPolicyWithComGoogleGsonLongSerializationPolicyEnum:", "setLongSerializationPolicy", "Lcom.google.gson.GsonBuilder;", 0x1, NULL, NULL },
    { "setFieldNamingPolicyWithComGoogleGsonFieldNamingPolicyEnum:", "setFieldNamingPolicy", "Lcom.google.gson.GsonBuilder;", 0x1, NULL, NULL },
    ...
    { "registerTypeHierarchyAdapterWithIOSClass:withId:", "registerTypeHierarchyAdapter", "Lcom.google.gson.GsonBuilder;", 0x1, NULL, NULL },
    ...
    { "addTypeAdaptersForDateWithNSString:withInt:withInt:withJavaUtilList:", "addTypeAdaptersForDate", "V", 0x2, NULL, NULL },
  };
  ...
  static const J2ObjcClassInfo _ComGoogleGsonGsonBuilder = { 2, "GsonBuilder", "com.google.gson", NULL, 0x11, 25, methods, 15, fields, 0, NULL, 0, NULL, NULL, NULL };
...
void ComGoogleGsonGsonBuilder_init(ComGoogleGsonGsonBuilder *self) {
  NSObject_init(self);
  JreStrongAssign(&self->excluder_, JreLoadStatic(ComGoogleGsonInternalExcluder, DEFAULT_));
  JreStrongAssign(&self->longSerializationPolicy_, JreLoadStatic(ComGoogleGsonLongSerializationPolicyEnum, DEFAULT));
  JreStrongAssign(&self->fieldNamingPolicy_, JreLoadStatic(ComGoogleGsonFieldNamingPolicyEnum, IDENTITY));
...
void ComGoogleGsonGsonBuilder_addTypeAdaptersForDateWithNSString_withInt_withInt_withJavaUtilList_(ComGoogleGsonGsonBuilder *self, NSString *datePattern, jint dateStyle, jint timeStyle, id<JavaUtilList> factories) {
  ...
  if (datePattern != nil && ![@"" isEqual:[datePattern trim]]) {
    dateTypeAdapter = [new_ComGoogleGsonDefaultDateTypeAdapter_initWithNSString_(datePattern) autorelease];
  }
  else if (dateStyle != JavaTextDateFormat_DEFAULT && timeStyle != JavaTextDateFormat_DEFAULT) {
    dateTypeAdapter = [new_ComGoogleGsonDefaultDateTypeAdapter_initWithInt_withInt_(dateStyle, timeStyle) autorelease];
  }
  else {
    return;
  }
