...
- (void)beginArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_ARRAY) {
    ...
    *IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1) = 0;
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected BEGIN_ARRAY but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
}
...
- (void)endArray {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_ARRAY) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected END_ARRAY but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
}
...
- (void)beginObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_BEGIN_OBJECT) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected BEGIN_OBJECT but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
}
...
- (void)endObject {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_END_OBJECT) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected END_OBJECT but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
}
...
- (ComGoogleGsonStreamJsonTokenEnum *)peek {
  ...
  switch (p) {
    ...
    return JreLoadStatic(ComGoogleGsonStreamJsonTokenEnum, END_OBJECT);
    ...
    return JreLoadStatic(ComGoogleGsonStreamJsonTokenEnum, END_ARRAY);
...
- (NSString *)nextName {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED_NAME) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a name but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
...
- (NSString *)nextString {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_UNQUOTED) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a string but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
  return result;
...
- (jboolean)nextBoolean {
  ...
  @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a boolean but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
}
...
- (void)nextNull {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NULL) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected null but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
}
...
- (jdouble)nextDouble {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a double but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  ...
  if (!lenient_ && (JavaLangDouble_isNaNWithDouble_(result) || JavaLangDouble_isInfiniteWithDouble_(result))) {
    @throw [new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$D$I$I$$", @"JSON forbids NaN and infinities: ", result, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jlong)nextLong {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a long but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  jlong result = JreFpToLong(asDouble);
  if (result != asDouble) {
    @throw [new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$I$I$$", @"Expected a long but was ", peekedString_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (jint)nextInt {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_LONG) {
    ...
    if (peekedLong_ != result) {
      @throw [new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$J$I$I$$", @"Expected an int but was ", peekedLong_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
    }
    peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
    (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
    return result;
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_NUMBER) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected an int but was ", [self peek], @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_BUFFERED;
  jdouble asDouble = JavaLangDouble_parseDoubleWithNSString_(peekedString_);
  result = JreFpToInt(asDouble);
  if (result != asDouble) {
    @throw [new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$$I$I$$", @"Expected an int but was ", peekedString_, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
  }
  JreStrongAssign(&peekedString_, nil);
  peeked_ = ComGoogleGsonStreamJsonReader_PEEKED_NONE;
  (*IOSIntArray_GetRef(nil_chk(pathIndices_), stackSize_ - 1))++;
...
- (NSString *)getPath {
  JavaLangStringBuilder *result = [((JavaLangStringBuilder *) [new_JavaLangStringBuilder_init() autorelease]) appendWithChar:'$'];
...
+ (void)initialize {
  if (self == [ComGoogleGsonStreamJsonReader class]) {
    JreStrongAssign(&ComGoogleGsonStreamJsonReader_NON_EXECUTE_PREFIX_, [@")]}'\n" toCharArray]);
    {
      JreStrongAssignAndConsume(JreLoadStaticRef(ComGoogleGsonInternalJsonReaderInternalAccess, INSTANCE_), new_ComGoogleGsonStreamJsonReader_$1_init());
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "NON_EXECUTE_PREFIX_", NULL, 0x1a, "[C", &ComGoogleGsonStreamJsonReader_NON_EXECUTE_PREFIX_, NULL, .constantValue.asLong = 0 },
    ...
    { "peeked_", NULL, 0x2, "I", NULL, NULL, .constantValue.asLong = 0 },
...
void ComGoogleGsonStreamJsonReader_initWithJavaIoReader_(ComGoogleGsonStreamJsonReader *self, JavaIoReader *inArg) {
  ...
  if (inArg == nil) {
    @throw [new_JavaLangNullPointerException_initWithNSString_(@"in == null") autorelease];
  }
...
NSString *ComGoogleGsonStreamJsonReader_nextUnquotedValue(ComGoogleGsonStreamJsonReader *self) {
  ...
  while (true) {
    ...
    if (builder == nil) {
      builder = [new_JavaLangStringBuilder_init() autorelease];
    }
    [((JavaLangStringBuilder *) nil_chk(builder)) appendWithCharArray:self->buffer_ withInt:self->pos_ withInt:i];
    self->pos_ += i;
    i = 0;
    if (!ComGoogleGsonStreamJsonReader_fillBufferWithInt_(self, 1)) {
      break;
...
jint ComGoogleGsonStreamJsonReader_nextNonWhitespaceWithBoolean_(ComGoogleGsonStreamJsonReader *self, jboolean throwOnEof) {
  ...
  if (throwOnEof) {
    @throw [new_JavaIoEOFException_initWithNSString_(JreStrcat("$I$I", @"End of input at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self))) autorelease];
  }
  else {
    return -1;
  }
    ...
    switch (escaped) {
      ...
      for (jint i = self->pos_, end = i + 4; i < end; i++) {
        ...
        if (c >= '0' && c <= '9') {
          ...
          @throw [new_JavaLangNumberFormatException_initWithNSString_(JreStrcat("$$", @"\\u", [NSString stringWithCharacters:self->buffer_ offset:self->pos_ length:4])) autorelease];
        }
      }
      self->pos_ += 4;
      return result;
...
JavaIoIOException *ComGoogleGsonStreamJsonReader_syntaxErrorWithNSString_(ComGoogleGsonStreamJsonReader *self, NSString *message) {
  @throw [new_ComGoogleGsonStreamMalformedJsonException_initWithNSString_(JreStrcat("$$I$I$$", message, @" at line ", ComGoogleGsonStreamJsonReader_getLineNumber(self), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(self), @" path ", [self getPath])) autorelease];
}
...
- (void)promoteNameToValueWithComGoogleGsonStreamJsonReader:(ComGoogleGsonStreamJsonReader *)reader {
  ...
  if (p == ComGoogleGsonStreamJsonReader_PEEKED_DOUBLE_QUOTED_NAME) {
    ...
    @throw [new_JavaLangIllegalStateException_initWithNSString_(JreStrcat("$@$I$I$$", @"Expected a name but was ", [reader peek], @"  at line ", ComGoogleGsonStreamJsonReader_getLineNumber(reader), @" column ", ComGoogleGsonStreamJsonReader_getColumnNumber(reader), @" path ", [reader getPath])) autorelease];
  }
}
