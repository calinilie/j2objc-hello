...
- (NSNumber *)getAsNumber {
  return [value_ isKindOfClass:[NSString class]] ? [new_ComGoogleGsonInternalLazilyParsedNumber_initWithNSString_((NSString *) check_class_cast(value_, [NSString class])) autorelease] : (NSNumber *) check_class_cast(value_, [NSNumber class]);
}
...
- (JavaMathBigDecimal *)getAsBigDecimal {
  return [value_ isKindOfClass:[JavaMathBigDecimal class]] ? (JavaMathBigDecimal *) check_class_cast(value_, [JavaMathBigDecimal class]) : [new_JavaMathBigDecimal_initWithNSString_([nil_chk(value_) description]) autorelease];
}

- (JavaMathBigInteger *)getAsBigInteger {
  return [value_ isKindOfClass:[JavaMathBigInteger class]] ? (JavaMathBigInteger *) check_class_cast(value_, [JavaMathBigInteger class]) : [new_JavaMathBigInteger_initWithNSString_([nil_chk(value_) description]) autorelease];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    { "PRIMITIVE_TYPES_", NULL, 0x1a, "[Ljava.lang.Class;", &ComGoogleGsonJsonPrimitive_PRIMITIVE_TYPES_, "[Ljava/lang/Class<*>;", .constantValue.asLong = 0 },
