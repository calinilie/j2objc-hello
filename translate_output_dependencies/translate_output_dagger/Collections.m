...
J2OBJC_STATIC_FIELD_GETTER(DaggerInternalCollections, MAX_POWER_OF_TWO, jint)
...
JavaUtilLinkedHashSet *DaggerInternalCollections_newLinkedHashSetWithExpectedSizeWithInt_(jint expectedSize) {
  ...
  return [new_JavaUtilLinkedHashSet_initWithInt_(DaggerInternalCollections_calculateInitialCapacityWithInt_(expectedSize)) autorelease];
}

JavaUtilLinkedHashMap *DaggerInternalCollections_newLinkedHashMapWithExpectedSizeWithInt_(jint expectedSize) {
  DaggerInternalCollections_initialize();
  return [new_JavaUtilLinkedHashMap_initWithInt_(DaggerInternalCollections_calculateInitialCapacityWithInt_(expectedSize)) autorelease];
}
